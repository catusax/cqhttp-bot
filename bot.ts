...
export class QBot {
    ws: WebSocket
    message_handlers: Array<messageHandler> = []
    at_message_handlers: Array<atMessageHandler> = []
    ...
    run() {
        ...
        this.ws.onmessage = async event => {
            ...
            if (data.post_type == 'message') {
                ...
                let message_event = new CqMessageEvent(data)
                // 消息事件
                ...
                let cqcode = new CqCode(message_event.message)
...
*/
export interface atMessageHandler {
    (message: CqMessageEvent, cqcode: CqCode): void
}
